...
namespace App\Filament\Resources\PaymentVerifications\PaymentVerifications;

use Filament\Schemas\Schema;
use Filament\Actions\Action;
use App\Filament\Resources\PaymentVerifications\Pages\ListPaymentVerifications;
use App\Filament\Resources\PaymentVerifications\Pages\CreatePaymentVerification;
use App\Filament\Resources\PaymentVerifications\Pages\EditPaymentVerification;
use App\Filament\Resources\PaymentVerifications\Pages;
        ...
        ->recordActions([
            ...
            Action::make('reject_payment')
               ...
               Action::make('view_documents')
                ...
                ->icon('heroicon-o-eye')
                ->color('warning')
                ->schema(function (OrderPayment $record) {
                    return [
                        // Customer Name
...
public static function getNavigationBadgeColor(): ?string
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => CreatePaymentVerification::route('/create'),
            'edit' => EditPaymentVerification::route('/{record}/edit'),
        ];
    }
}
