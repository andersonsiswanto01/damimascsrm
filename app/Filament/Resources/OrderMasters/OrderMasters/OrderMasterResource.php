...
namespace App\Filament\Resources\OrderMasters\OrderMasters;
...
use App\Filament\Resources\OrderMasters\RelationManagers\CorporateSp2bksRelationManager;
use App\Filament\Resources\OrderMasters\Pages\ListOrderMasters;
use App\Filament\Resources\OrderMasters\Pages\CreateOrderMaster;
use App\Filament\Resources\OrderMasters\Pages\EditOrderMaster;
use App\Filament\Resources\OrderMasters\Pages;
use App\Filament\Resources\OrderMasters\RelationManagers;
...
{
    return [
        CorporateSp2bksRelationManager::class,
    ];
}
    ...
    {
        return [
            'index' => ListOrderMasters::route('/'),
            'create' => CreateOrderMaster::route('/create'),
            'edit' => EditOrderMaster::route('/{record}/edit'),
        ];
    }
}
