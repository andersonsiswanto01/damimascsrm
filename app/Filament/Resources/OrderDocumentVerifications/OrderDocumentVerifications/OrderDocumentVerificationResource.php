...
namespace App\Filament\Resources\OrderDocumentVerifications\OrderDocumentVerifications;

use Filament\Schemas\Schema;
use Filament\Actions\Action;
use Carbon\Carbon;
use Filament\Actions\BulkAction;
use App\Filament\Resources\OrderDocumentVerifications\Pages\ListOrderDocumentVerifications;
use App\Filament\Resources\OrderDocumentVerifications\Pages\CreateOrderDocumentVerification;
use App\Filament\Resources\OrderDocumentVerifications\Pages\EditOrderDocumentVerification;
use App\Filament\Resources\OrderDocumentVerifications\Pages;
...
public static function getNavigationLabel(): string
{
    ...
    {
        return [
            'index' => ListOrderDocumentVerifications::route('/'),
            'create' => CreateOrderDocumentVerification::route('/create'),
            'edit' => EditOrderDocumentVerification::route('/{record}/edit'),
        ];
    }
}
