...
namespace App\Filament\Resources\DisBunVerifications\DisBunVerifications;
...
use App\Filament\Resources\DisBunVerifications\Pages\ListDisBunVerifications;
        ...
        return $table
            ...
            ->toolbarActions([
                BulkActionGroup::make([
                    ...
                    BulkAction::make('Verify Selected')
    ...
    public static function getFormActions(): array
{
    ...
    {
        return [
            'index' => ListDisBunVerifications::route('/'),
        ];
    }
}
